...
import iconDiskin from '../../assets/icon-diskin.png';

// ↓↓ 1. 在这里，导入我们刚刚创建的 UI 组件 ↓↓
import { DockerNodeComponent } from './DiskinNodeComponent'; 

let index = 0;
export const DiskinNodeRegistry: FlowNodeRegistry = {
  type: WorkflowNodeType.Diskin,
  category: '数据IO',
  info: {
    icon: iconDiskin,

...
import iconGpp from '../../assets/icon-GPP.png';

// ↓↓ 1. 在这里，导入我们刚刚创建的 UI 组件 ↓↓
import { DockerNodeComponent } from './DockerNodeComponent'; 

let index = 0;
export const GPPNodeRegistry: FlowNodeRegistry = {
  type: WorkflowNodeType.GPP,
  category: '执行节点',
  info: {
    icon: iconGpp,

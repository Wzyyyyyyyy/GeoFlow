...
import iconMpi from '../../assets/icon-MPI.png';

// ↓↓ 1. 在这里，导入我们刚刚创建的 UI 组件 ↓↓
import { DockerNodeComponent } from './MpiNodeComponent'; 

let index = 0;
export const MPINodeRegistry: FlowNodeRegistry = {
  type: WorkflowNodeType.MPI,
  category: '执行节点',
  info: {
    icon: iconMpi,
